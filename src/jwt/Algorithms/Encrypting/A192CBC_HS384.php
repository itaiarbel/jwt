 ...
 */
class A192CBC_HS384 implements EncryptingAlgorithm
{
    ...
    {    
        ...
        return openssl_encrypt($data, 'AES-192-CBC', $key, OPENSSL_RAW_DATA, $iv);
    }

    static function decrypt($data, $key, $iv, &$tag)
    {
        $tag=null; // -> force jwe class to call auth_tag()
        return openssl_decrypt($data, 'AES-192-CBC', $key, OPENSSL_RAW_DATA, $iv);         
    }
